  ...
  events: [
    {
      ...
      detailFields: [
        ...
        { label: 'Sanction Reference ID', value: 'EU.9247883' },
    ...
    },
    {
      ...
      detailFields: [
        ...
        { label: 'Sanction Reference ID', value: 'RUS2550' },
        { label: 'Status', value: 'Active' },
      ],
    },
    {
      ...
      afterValue: 'HATTI',
      chips: [{ label: 'Alias', tone: 'name' }],
      detailFields: [
        { label: 'Provider', value: 'EU, UK' },
        { label: 'Alias Value', value: 'HATTI' },
        { label: 'Source', value: 'Sanctions source record' },
      ],
    },
    {
      id: 'a8',
      ...
      detailFields: [
        { label: 'Associated MMSI', value: '314996000' },
        { label: 'Source', value: 'Sanctions source record' },
      ],
    },
    {
